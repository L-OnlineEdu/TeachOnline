    ...
    var _ret = (function () {
      ...
      switch (params.type) {
        ...
        case 'input':
            ...
            _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.removeClass(modal, 'show-inputx');
            setTimeout(function () {
                $input.focus();
            ...
            break;
        case 'prompt':
            _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide.addClass(modal, 'show-inputx');
            break;
          break;
      }
    })();
