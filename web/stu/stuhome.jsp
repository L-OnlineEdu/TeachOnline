    ...
    <div class="navbar-fixed">
        <nav class="cyan">
            <div class="nav-wrapper">
                <h1 class="logo-wrapper"><a href="/stu/stuhome.jsp" class="brand-logo darken-1"><img src="/utils/img/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Materialize</span></h1>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content  white-text" style="background:#5BE7C4">
                    ...
                    <p class="card-stats-compare"><i class="mdi-hardware-keyboard-arrow-up"></i> <span class="green-text text-lighten-5">最后一次测验分数</span>
                    </p>
                </div>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content" style="background:#F5F7FA">
                    ...
                    <p class="card-stats-compare"><i class="mdi-hardware-keyboard-arrow-up"></i>  <span class="text-lighten-5">收到警告数目</span>
                    </p>
                </div>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content white-text" style="background:#50C1E9">
                    ...
                    <p class="card-stats-compare"><i class="mdi-hardware-keyboard-arrow-down"></i><span class="deep-purple-text text-lighten-5" id="lexamtime">上次测验时间YYYY-MM-HH-SS</span>
                    </p>
                </div>
        ...
        <div class="col s12 m6 l4">
            <div id="profile-card" class="card">
                ...
                <div class="card-content">
                    <img src="/utils/ava/${user.uid}.jpg" alt="" class="circle responsive-img activator card-profile-image">
                    <a href="/qn/question.html?flag=a&&rid=0&&type=0" class="btn-floating activator btn-move-up waves-effect waves-light darken-2 right">
