...
<div class="main">
    ...
    <form action="correctpaper" id="submitForm" method="post">
        ...
        <input type="hidden" name="practiceid" value="<s:property value="practiceid"/>">
            ...
            <div class="test">
                <form action="" method="post">
                    <div class="test_title">
                        ...
                        <font><input type="button" name="test_jiaojuan" onclick="ti_jiao()" value="交卷"></font>
                    </div>
            ...
            <div class="nr_rt_main">
                <div class="rt_nr1">
                    <div class="rt_nr1_title">
                        ...
                        <p class="test_time">
                            <i class="icon iconfont">&#xe6fb;</i><b class="alt-1"><s:property value="practiceTimeStr"/></b>
                        </p>
                    </div>
