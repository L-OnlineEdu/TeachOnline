    ...
    oTree.prototype = {
        ...
        searchFuc: function(data){
            ...
            var sdom = '<div class="multiPickerDlg_search_wrapper">'
                     ...
                     + '<input type="text"id="memberSearchInput"class="qui_inputText ww_inputText ww_searchInput_text" placeholder="搜索学生"></span>'
                     + '</div>'
