...
<div>
                ...
                <div class="bigBtn">
                    <div style="width: 100%; padding: 0px; border-radius: 4px;">
                        <div style="width: 100%; display: flex; background-color: white; flex-direction: row; box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 2px 0px; position: relative; height: 60px; cursor: pointer;">
                            ...
                            <div onclick="window.open('/tea/pushpaper.jsp')" style="position: relative; overflow: hidden; -webkit-box-flex: 1; flex: 1 1 0%; height: 60px;">
                                <div style="color: rgb(238, 238, 238); font-size: 64px; position: absolute; bottom: -32px; right: -16px;">
    ...
    <div class="result-overview-box"
        ...
        <div id="showAted" style="padding: 16px 0px; display: flex; flex-direction: column; box-sizing: border-box; overflow: hidden; -webkit-box-flex: 1; flex: 1 1 0%;">
            <div id="showtext">
            ...
            <div style="display: flex; flex-direction: row; padding: 0px 20px; height: 25px; flex-shrink: 0; position: relative; justify-content: space-between;">
                ...
                <input type="hidden" id="courseId" value="<s:property value="courseId"/>">
    ...
    <div style="background:url(../qn/css/img/no-students.png) no-repeat 50% 50%; ">
<!--   评价卡片块        -->
    <div class="col s12 m6 l3" style="width: 230px">
        <div class="card">
            <div class="card-content  white-text" style="background:#5BE7C4">
                ...
                <p class="card-stats-compare"><i class="mdi-hardware-keyboard-arrow-up"></i> <span class="green-text text-lighten-5">老师-学生</span>
                </p>
            </div>
    ...
    <div class="col s12 m6 l3" style="width: 230px">
        <div class="card">
            <div class="card-content  white-text" style="background:#7A57D1">
                ...
                <p class="card-stats-compare"><i class="mdi-hardware-keyboard-arrow-up"></i> <span class="purple-text text-lighten-5">学生-老师 学生-学生</span>
                </p>
            </div>
